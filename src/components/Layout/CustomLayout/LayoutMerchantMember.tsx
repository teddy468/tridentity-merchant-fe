...
import { menusMerchantMember } from "../../../commons/constants/menus";
...
const LayoutMerchantMember: FC<{ children: ReactNode }> = ({ children }) => {
      ...
      <Layout>
        <Layout.Header className={styles.header}>
          <Breadcrumb separator="" className={styles.breadcrumb_cover}>
            ...
            {Number(currentStore?.id) > 0 && <Breadcrumb.Item href={routers.STORES.LIST}>Store</Breadcrumb.Item>}
...
export default LayoutMerchantMember;
